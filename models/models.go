...
type DailyReport struct {
	...
	Purchases       DailyReportMetric `json:"purchases"` // purchase expense = full invoice totals
	...
	// AccountsPayableTotal is overall outstanding AP across all open purchase bills.
